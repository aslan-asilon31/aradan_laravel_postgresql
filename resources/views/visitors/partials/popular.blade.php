      ...
      <div class="swiper-wrapper">
        ...
        >
          <figure class="figure d-block popular-picks-figure mb-0">
            <img
              ...
              src="{{asset('assets/frontend/img/popular-picks-01.jpg')}}"
              alt=""
            />
          </figure>
        </div>
        ...
        >
          <figure class="figure d-block popular-picks-figure mb-0">
            <img
              class="figure-img img-fluid d-block mx-auto mb-0"
              src="{{asset('assets/frontend/img/popular-picks-02.jpg')}}"
              alt=""
            />
          </figure>
        </div>
        ...
        >
          <figure class="figure d-block popular-picks-figure mb-0">
            <img
              class="figure-img img-fluid d-block mx-auto mb-0"
              src="{{asset('assets/frontend/img/popular-picks-03.jpg')}}"
              alt=""
            />
          </figure>
        </div>
